	...
	return (
		<>
			...
			<div className="flex flex-wrap justify-center mt-10">
				...
				<div className="w-1/4 m-2">
					<Link to="/procurement-staff/login">
						<div className="bg-white shadow-md rounded-lg p-4">
							<div className="flex flex-col items-center">
								<div className="w-20 h-20 rounded-full bg-gray-200 flex justify-center items-center">
									<img src="https://img.icons8.com/external-flaticons-lineal-color-flat-icons/64/000000/external-tour-guide-travel-agency-flaticons-lineal-color-flat-icons-2.png" />
								</div>
								<h3 className="text-gray-700 font-medium text-lg mt-3">Procurement Staff</h3>
								<span className="text-sm text-gray-500">Manage our Procurements</span>
							</div>
						</div>
					</Link>
				</div>
					...
					<Link to="/supplier/login">
						<div className="bg-white shadow-md rounded-lg p-4">
							<div className="flex flex-col items-center">
								...
								<h3 className="text-gray-700 font-medium text-lg mt-3">Supplier</h3>
								<span className="text-sm text-gray-500">Manage our suppliers</span>
							</div>
						</div>
					</Link>
				</div>
					...
					<Link to="/manager/login">
						<div className="bg-white shadow-md rounded-lg p-4">
							<div className="flex flex-col items-center">
								...
								<h3 className="text-gray-700 font-medium text-lg mt-3">Manager</h3>
								<span className="text-sm text-gray-500">Manage our company</span>
							</div>
						</div>
					</Link>
				</div>
