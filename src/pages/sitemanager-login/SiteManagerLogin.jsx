...
import SiteManager from "../../contexts/SiteManagerContext";

const SiteManagerLogin = () => {
	const { siteManagerLogin } = useContext(SiteManager);
	...
	const handleSubmit = (e) => {
		...
		siteManagerLogin(newSiteManager);
	};

	return (
		<>
			<h1 className="mt-5 text-4xl text-center">Site Manager Login</h1>
