...
import ProcurementStaffContext from "../../contexts/ProcurementStaffContext";

const ProcurementStaffRegister = () => {
	const { register } = useContext(ProcurementStaffContext);
	...
	const handleSubmit = (e) => {
		...
		register(newProcurementStaff);
	};

	return (
		<>
			<h1 className="mt-5 text-4xl text-center font-bold">Procurement Staff Register</h1>
...
export default ProcurementStaffRegister;
