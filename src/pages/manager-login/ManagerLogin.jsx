...
import Manager from "../../contexts/ManagerContext";

const ManagerLogin = () => {
	const { ManagerLogin } = useContext(Manager);
	...
	const handleSubmit = (e) => {
		...
		ManagerLogin(newManager);
	};
	return (
		<>
			<h1 className="mt-5 text-4xl text-center">Manager Login</h1>
